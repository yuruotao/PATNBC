...
class photoacoustic_data_reader():
    # initialize the class
    def __init__(self, folderPath=None, scanName=None, averaging=False, averagingAxis=2):
        logging.info('  Class       "photoacoustic_data_reader"          : %s', __name__)
        ...
        if self.folderPath == None or scanName is None:
        ...
        # remove the first 2 samples as they do not have signals
    ...
    averaging: Whether to apply averaging or not (default = False)
    averagingAxis: If averaging True, average through this axis
    return: photoacoustic_data_reader object
    """
